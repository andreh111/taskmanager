...
SECRET_KEY = "django-insecure-bm_ipi1uu=@tg&qgk2c6c!ay5wc^xue!!l9#v@@c%5699)s-3q"
...
DATABASES = {
    ...
    'mongodb': {
        'ENGINE': 'djongo',
        'NAME': 'taskmanager_log_db',
        'CLIENT': {
            'host': 'mongodb://root:rootpassword@mongodb_container:27017'
        }
    }
}
